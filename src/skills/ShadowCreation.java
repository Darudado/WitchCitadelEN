...
public class ShadowCreation {
    ...
    public static class DarkReal implements AdvanceableListener {
        ...
        protected String id = "WitchSC1";
        protected String id233 = "WitchSC2";
    ...
    public static class Level1B extends BaseSkillEffectDescription implements ShipSkillEffect, AfterShipCreationSkillEffect {
        ...
        public void createCustomDescription(MutableCharacterStatsAPI stats, SkillSpecAPI skill, TooltipMakerAPI info, float width) {
            ...
            float pad = 5.0F;
            float pads = 2.0F;
            info.addPara("All ships will restore to maximum combat readiness after entering battle", WthC_ColorData.MYSTERIOUS_PURPLE,pad);
    ...
    public static class Level2A extends BaseSkillEffectDescription implements ShipSkillEffect, AfterShipCreationSkillEffect {
        ...
        public void apply(MutableShipStatsAPI stats, ShipAPI.HullSize hullSize, String id, float level) {
            stats.getDynamic().getMod(Stats.INDIVIDUAL_SHIP_RECOVERY_MOD).modifyFlat(id, -2000f);
            stats.getCombatEngineRepairTimeMult().modifyMult(id, 0.8F);
            stats.getCombatWeaponRepairTimeMult().modifyMult(id, 0.8F);
        }
    ...
    public static class Level2B extends BaseSkillEffectDescription implements ShipSkillEffect, AfterShipCreationSkillEffect {
        ...
        public void createCustomDescription(MutableCharacterStatsAPI stats, SkillSpecAPI skill, TooltipMakerAPI info, float width) {
            ...
            info.addPara("Disabled ships can usually only be repaired with story points", WthC_ColorData.HIGH_BLUE,pad);
            info.addPara("Ships' weapons and engines repair speed will be slightly increased in combat", WthC_ColorData.HIGH_BLUE,pads);
