...
public class Contract {
    ...
    public static class Level1 extends BaseSkillEffectDescription implements ShipSkillEffect, AfterShipCreationSkillEffect {
        ...
        public void unapplyEffectsAfterShipCreation(ShipAPI ship, String id) {
            ship.removeListenerOfClass(CT1.class);
        }
        ...
        public void createCustomDescription(MutableCharacterStatsAPI stats, SkillSpecAPI skill, TooltipMakerAPI info, float width) {
            ...
            info.addPara(" %s ballistic and energy weapon rate of fire", pad, WthC_ColorData.CROSS_GARY, new String[]{"+5%"});
            info.addPara(" %s shield flux dissipation when active", pad, WthC_ColorData.IE_WHITE, new String[]{"+5%"});
            info.addPara(" %s ship damage reduction", pad, WthC_ColorData.DEEP_BLUE, new String[]{"+5%"});
            info.addPara(" %s ship time flow rate", pad, WthC_ColorData.SOUL_GREEN_D, new String[]{"+5%"});
            info.addPara(" %s ship maximum speed", pad, WthC_ColorData.EIF_ORANGE, new String[]{"+5%"});
        }
    }
        ...
        public static class Level2 extends BaseSkillEffectDescription implements ShipSkillEffect, AfterShipCreationSkillEffect {
            ...
            public void unapplyEffectsAfterShipCreation(ShipAPI ship, String id) {
                ship.removeListenerOfClass(CT2.class);
            }
            ...
            public void createCustomDescription(MutableCharacterStatsAPI stats, SkillSpecAPI skill, TooltipMakerAPI info, float width) {
                ...
                float pad = 5.0F;
                info.addPara("When ship's hull is %s, all base bonuses increase to %s", pad, WthC_ColorData.HIGH_BLUE, new String[]{"<50%","10%"});
            }
        }
