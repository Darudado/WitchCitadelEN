...
public class WthC_Erosion3 extends BaseHullMod {
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        if (ship != null) {
            ...
            tooltip.addPara("Actively releasing a certain amount of stellar energy mist will make the ship's interior even more perilous, and the increasingly difficult survival environment will affect combat power to some extent", WthC_ColorData.DUST_PURPLE, pad);
    ...
    public boolean isApplicableToShip(ShipAPI ship) {
        return (ship.getVariant().hasHullMod("erosion2"));
    }

    public String getUnapplicableReason(ShipAPI ship) {
        return "Second stage of stellar energy mist erosion required";
    }
