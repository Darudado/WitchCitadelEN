...
import data.skills.DR_WitchElf;
...
//部分格式来源于北极星
public class WthC_ShadowRemain_Elf extends BaseHullMod {
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        if (ship != null) {
            ...
            tooltip.addPara("     %s " + strings.get("ShadowRemain_Elf_TEXT0"), pad, Misc.getHighlightColor(), "#","Time","Quick readiness recovery rate");
            tooltip.addPara("         %s " + strings.get("ShadowRemain_Elf_TEXT1"), padS, WthC_ColorData.HIGH_BLUE,"#","180");
            tooltip.addPara("         %s " + strings.get("ShadowRemain_Elf_TEXT2"), padS, WthC_ColorData.HIGH_BLUE,"#","5","100%");
    ...
    public void applyEffectsAfterShipCreation(ShipAPI ship, String id) {
        ...
        for (String tmp : BLOCKED_HULLMODS) {
            if (ship.getVariant().getHullMods().contains(tmp)) {
                MagicIncompatibleHullmods.removeHullmodWithWarning(ship.getVariant(), tmp, "shadowremainelf");
            }
        }
    ...
    public String getUnapplicableReason(ShipAPI ship) {
        ...
        static {
        BLOCKED_HULLMODS.add("ringinterfereelf");
