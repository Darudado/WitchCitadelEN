...
//部分格式来源于北极星
public class WthC_ShadowRemain_IE extends BaseHullMod {
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        if (ship != null) {
            ...
            tooltip.addPara("     %s " + strings.get("ShadowRemain_IE_TEXT0"), pad, Misc.getHighlightColor(), "#","First encounter","Quick dissipation");
            tooltip.addPara("         %s " + strings.get("ShadowRemain_IE_TEXT1"), padS, WthC_ColorData.HIGH_BLUE,"#","80%","3");
            tooltip.addPara("         %s " + strings.get("ShadowRemain_IE_TEXT2"), padS, WthC_ColorData.HIGH_BLUE,"#","3","500%");
    ...
    public void applyEffectsAfterShipCreation(ShipAPI ship, String id) {
        ...
        for (String tmp : BLOCKED_HULLMODS) {
            if (ship.getVariant().getHullMods().contains(tmp)) {
                MagicIncompatibleHullmods.removeHullmodWithWarning(ship.getVariant(), tmp, "shadowremainie");
            }
        }
    ...
    public String getUnapplicableReason(ShipAPI ship) {
        ...
        static {
        BLOCKED_HULLMODS.add("ringinterfereie");
