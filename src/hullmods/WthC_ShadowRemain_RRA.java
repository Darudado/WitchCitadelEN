...
//部分格式来源于北极星
public class WthC_ShadowRemain_RRA extends BaseHullMod {
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        if (ship != null) {
            ...
            tooltip.addPara("     %s " + strings.get("ShadowRemain_RRA_TEXT0"), pad, Misc.getHighlightColor(), "#","First damage","Short period");
            tooltip.addPara("         %s " + strings.get("ShadowRemain_RRA_TEXT1"), padS, WthC_ColorData.HIGH_BLUE,"#","95%");
            tooltip.addPara("         %s " + strings.get("ShadowRemain_RRA_TEXT2"), padS, WthC_ColorData.HIGH_BLUE,"#","5");
    ...
    public void applyEffectsAfterShipCreation(ShipAPI ship, String id) {
        ...
        for (String tmp : BLOCKED_HULLMODS) {
            if (ship.getVariant().getHullMods().contains(tmp)) {
                MagicIncompatibleHullmods.removeHullmodWithWarning(ship.getVariant(), tmp, "shadowremainrra");
            }
        }
    ...
    public String getUnapplicableReason(ShipAPI ship) {
        ...
        static {
        BLOCKED_HULLMODS.add("ringinterfererra");
