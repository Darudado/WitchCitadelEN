...
//从高能聚焦修改
public class StigmataExcite extends BaseShipSystemScript {
    ...
    */
    ...
    public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
            ...
            stats.getBallisticWeaponFluxCostMod().modifyMult(id, 0F);
            stats.getEnergyWeaponFluxCostMod().modifyMult(id, 0F);
        ...
        ship.getVelocity().set(VectorUtils.rotate(new Vector2f(300f, -100f), ship.getFacing() + 90f));
    ...
    public StatusData getStatusData(int index, State state, float effectLevel) {
        if (index == 0) {
            ...
            return new StatusData("Non-missile weapons no longer generate flux when firing", false);
        } else if (index == 3){
            return new StatusData("+50% non-missile weapon range", false);
        } else if (index == 4){
            return new StatusData("-50% projectile speed", true);
        } else if (index == 5){
