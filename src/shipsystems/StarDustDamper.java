...
public class StarDustDamper extends BaseShipSystemScript {
    ...
    public void apply(MutableShipStatsAPI stats, String id, ShipSystemStatsScript.State state, float effectLevel) {
        ...
        if (player) {
            ...
            if (system != null) {
                ...
                Global.getCombatEngine().maintainStatusForPlayerShip(this.STATUSKEY1, system.getSpecAPI().getIconSpriteName(), system.getDisplayName(), Math.round(percent) + "% damage taken reduced", false);
            }
        }
    ...
    public static ShipSystemAPI getDamper(ShipAPI ship) {
        ...
        if (system != null && system.getId().equals("damper")) {
            return system;
        } else if (system != null && system.getId().equals("damper_omega")) {
            return system;
        } else {
