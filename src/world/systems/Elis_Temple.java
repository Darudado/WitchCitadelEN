...
//从军用市场修改
public class Elis_Temple extends BaseSubmarketPlugin {
    public static Logger log = Global.getLogger(Elis_Temple.class);
    ...
    public String getName() {
        return this.submarket.getFaction().getId().equals("crimson_treasure") ? "Crimson" :  "Elis Temple";
    }
