...
//从军用市场修改
public class        Warehouse_Dust extends BaseSubmarketPlugin {
    public static Logger log = Global.getLogger(Warehouse_Dust.class);
    private RepLevel minStanding;

    public Warehouse_Dust() {
    ...
    @Override
    public float getTariff() {return 0.15f;}


    public String getName() {
        return this.submarket.getFaction().getId().equals("warehouse_dust") ? "Crimson" :  "Shipboard Warehouse";
    }
