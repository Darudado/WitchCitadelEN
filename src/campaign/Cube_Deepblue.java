...
public class Cube_Deepblue extends BaseSpecialItemPlugin{
    ...
    public void createTooltip(TooltipMakerAPI tooltip, boolean expanded, CargoTransferHandlerAPI transferHandler, Object stackSource) {
        ...
        tooltip.addPara("At least... I won't have such bad taste as some others, rest assured...", WthC_ColorData.IE_WHITE, pad);
        tooltip.addPara("But... isn't participating in such a high-risk activity itself not a rational decision?", WthC_ColorData.IE_WHITE, padS);
    ...
    public void performRightClickAction() {
        ...
        if (RandomNumber1 <= 1F) {
            Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                    "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received... the complete AI core family~! (1% chance)");
            Global.getSector().getPlayerFleet().getCargo().addCommodity("alpha_core",1f);
            Global.getSector().getPlayerFleet().getCargo().addCommodity("beta_core",2f);
            Global.getSector().getPlayerFleet().getCargo().addCommodity("gamma_core",4f);

        } else if(RandomNumber1 <= 3F){
            float RandomNumber2 = MathUtils.getRandomNumberInRange(0F, 100F);
            if(RandomNumber2 <= 25F){
                Global.getSector().getPlayerFleet().getCargo().addWeapons("WthC_LiLancedeepblue",1);
                Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                        "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received... 1 mysterious large energy weapon~ (2% chance)");
            } else if (RandomNumber2 <= 50F){
                Global.getSector().getPlayerFleet().getCargo().addWeapons("WthC_LiLancecrimson",1);
                Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                        "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received... 1 mysterious large energy weapon~ (2% chance)");
            } else if (RandomNumber2 <= 75F){
                Global.getSector().getPlayerFleet().getCargo().addWeapons("WthC_LiLancepale",1);
                Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                        "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received... 1 mysterious large energy weapon~ (2% chance)");
            } else {
                Global.getSector().getPlayerFleet().getCargo().addFighters("WthC_NSP_wing",1);
                Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                        "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received... 1 super fighter LPC (2% chance)");
            }
        } else if(RandomNumber1 <= 10F){
            float RandomNumber2 = MathUtils.getRandomNumberInRange(0F, 100F);
            if(RandomNumber2 <= 66F){
                Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                        "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received... 1 mysterious medium energy weapon~ (7% chance)");
            ...
            if (!Global.getSector().getMemoryWithoutUpdate().getBoolean("$WthC_A1-ON")){
                ...
                Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                        "You activated a Deep Blue Cube... Accompanied by a magnificent light show, some strange information appeared on the cube~ (10% chance)");
                ...
                Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                        "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received... a Transfer Protocol Card (Story Point)~! (10% chance)");
                ...
                if (RandomNumber3 <= 33F){
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received... a Transfer Protocol Card (Crew)~! (15% chance)");
                    ...
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received... a Transfer Protocol Card (Supplies)~! (15% chance)");
                    Global.getSector().getPlayerFleet().getCargo().addSpecial(new SpecialItemData("Agreement_Supplies", "special_items"), 1);
                } else {
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received... a Transfer Protocol Card (Fuel)~! (15% chance)");
            ...
            Global.getSector().getPlayerFleet().getCargo().getCredits().add(25000);
                float RandomNumber4 = MathUtils.getRandomNumberInRange(0F, 100F);
                if (RandomNumber4 <= 10F){
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received an admonition with 25,000 credits... (Stop here... Persean... 25% chance)");
                } else if (RandomNumber4 <= 20F){
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received an admonition with 25,000 credits... (You should do something more worthwhile... 25% chance)");
                } else if(RandomNumber4 <= 30F){
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received an admonition with 25,000 credits... (500% difficulty is the best source of story points... 25% chance)");
                } else if(RandomNumber4 <= 40F) {
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received an admonition with 25,000 credits... (Remember to prioritize improving the spaceport... 25% chance)");
                } else if(RandomNumber4 <= 50F) {
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received an admonition with 25,000 credits... (Automated Control Enhancement will give you unparalleled power 25% chance)");
                } else if(RandomNumber4 <= 60F) {
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received an admonition with 25,000 credits... (Enough LRMs can overwhelm everything 25% chance)");
                } else if(RandomNumber4 <= 70F) {
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received an admonition with 25,000 credits... (40 flight decks can help you defeat 99% of opponents 25% chance)");
                } else if(RandomNumber4 <= 80F) {
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received an admonition with 25,000 credits... (A smaller total scale is your best friend when traveling alone 25% chance)");
                } else if(RandomNumber4 <= 90F) {
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received an admonition with 25,000 credits... (Your actions are nothing but for more credits after all 25% chance)");
                } else {
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received an admonition with 25,000 credits... (Sometimes turning off the transponder will make things twice as easy 25% chance)");
                }
        } else {
                Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                        "You activated a Deep Blue Cube... Accompanied by a magnificent light show, you received... a bunch of decorative weapons that are better than nothing (40% chance - guaranteed reward)");
