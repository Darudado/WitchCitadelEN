...
public class Crad_RRA extends BaseSpecialItemPlugin{
    ...
    public void createTooltip(TooltipMakerAPI tooltip, boolean expanded, CargoTransferHandlerAPI transferHandler, Object stackSource) {
        ...
        tooltip.addPara("It seems like another turbulent journey is about to begin...", WthC_ColorData.DEEP_BLUE, padS);
    }
    ...
    public void performRightClickAction() {
        ...
        this.officer.setId("WitchRRA");
        this.officer.setPortraitSprite(Global.getSettings().getSpriteName("intel", "WY1"));
        ...
        FleetMemberAPI member = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "WthC_conquest_IE_B_N_New");
        Global.getSector().getPlayerFleet().getFleetData().addFleetMember(member);

        CoreReputationPlugin.CustomRepImpact impact = new CoreReputationPlugin.CustomRepImpact();
        impact.delta = 0.5f;
        ReputationActionResponsePlugin.ReputationAdjustmentResult result = Global.getSector().adjustPlayerReputation(new CoreReputationPlugin.RepActionEnvelope(CoreReputationPlugin.RepActions.CUSTOM, impact, null, null, true), WthC_Citadel.getYOUYU());
        Global.getSector().getPlayerFleet().getCargo().addSpecial(new SpecialItemData("Crad_RRA2", "special_items"), 1.0F);
        Global.getSoundPlayer().playUISound(getSpec().getSoundId(), 1f, 1f);
        Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                "You have gained the recognition of a witch. She has helped you fully restore your flagship and will assist you remotely as a special officer throughout your journey.");
    }
}
