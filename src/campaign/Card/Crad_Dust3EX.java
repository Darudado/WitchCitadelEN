...
public class Crad_Dust3EX extends BaseSpecialItemPlugin{
    ...
    public void performRightClickAction() {
        ...
        for(OfficerDataAPI member : this.player_fleet.getFleetData().getOfficersCopy()) {
            ...
            if(Objects.equals(officers.getId(), "WitchDustEX")){
                ...
                for (FleetMemberAPI member2 : this.player_fleet.getFleetData().getMembersListCopy()) {
                    ...
                    if(Objects.equals(officer2.getId(), "WitchDustEX")){
            ...
            Global.getSector().getMemoryWithoutUpdate().set("$DustEX-ON",false);
