...
public class Crad_RRA3EX extends BaseSpecialItemPlugin{
    ...
    public void createTooltip(TooltipMakerAPI tooltip, boolean expanded, CargoTransferHandlerAPI transferHandler, Object stackSource) {
        ...
        tooltip.addPara(strings.get("CardRe2"), pad, WthC_ColorData.HIGH_BLUE, "Wuxin Youyu");
        tooltip.addPara(strings.get("CardRe3"), padS, WthC_ColorData.HIGH_BLUE, "Enigmatic Witch");
        tooltip.addPara(strings.get("CardRe4"), padS, WthC_ColorData.HIGH_BLUE, "This witch knows well how to protect herself while providing support from a distance...");
        tooltip.addPara("She excels at delivering precise fire support from extreme ranges and quickly disengaging when her ship faces significant threats.", WthC_ColorData.HIGH_BLUE, padS);
        ...
        tooltip.addPara("Now... you are one step closer to their legendary forms...", WthC_ColorData.B_WHITE, pad);
    }
    ...
    public void performRightClickAction() {
        ...
        for(OfficerDataAPI member : this.player_fleet.getFleetData().getOfficersCopy()) {
            ...
            if(Objects.equals(officers.getId(), "WitchRRAEX")){
                ...
                for (FleetMemberAPI member2 : this.player_fleet.getFleetData().getMembersListCopy()) {
                    ...
                    if(Objects.equals(officer2.getId(), "WitchRRAEX")){
        ...
        Global.getSector().getMemoryWithoutUpdate().set("$RRAEX-ON",false);
