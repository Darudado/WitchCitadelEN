...
public class Crad_Elf3EX extends BaseSpecialItemPlugin{
    ...
    public void performRightClickAction() {
        ...
        for(OfficerDataAPI member : this.player_fleet.getFleetData().getOfficersCopy()) {
            ...
            if(Objects.equals(officers.getId(), "WitchElfEX")){
                ...
                for (FleetMemberAPI member2 : this.player_fleet.getFleetData().getMembersListCopy()) {
                    ...
                    if(Objects.equals(officer2.getId(), "WitchElfEX")){
        ...
        Global.getSector().getMemoryWithoutUpdate().set("$ElfEX-ON",false);
