...
// 从双面神等道具缝合而来
public class Crad_B3 extends BaseSpecialItemPlugin{
    ...
    public void createTooltip(TooltipMakerAPI tooltip, boolean expanded, CargoTransferHandlerAPI transferHandler, Object stackSource) {
        ...
        tooltip.addPara("Current state of the Doctrine of Dominance: %s ", pad, Misc.getNegativeHighlightColor(), new String[]{"Rejected"});
        ...
        tooltip.addPara("(Using it again will reapply these effects...)", WthC_ColorData.MID_WHITE, padS);
    ...
    public void performRightClickAction() {
        ...
        Global.getSector().getPlayerFleet().getCargo().addSpecial(new SpecialItemData("Crad_B2", "special_items"), 1.0F);
        Global.getSector().getPlayerStats().setSkillLevel("Overmind_Doctrine", 2.0F);

        Global.getSoundPlayer().playUISound(getSpec().getSoundId(), 1f, 1f);
        Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                "Should you really embrace this inspiration...?");
    }
}
