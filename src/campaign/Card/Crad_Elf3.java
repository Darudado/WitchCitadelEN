...
public class Crad_Elf3 extends BaseSpecialItemPlugin{
    ...
    public void createTooltip(TooltipMakerAPI tooltip, boolean expanded, CargoTransferHandlerAPI transferHandler, Object stackSource) {
        ...
        tooltip.addPara(strings.get("CardRe4"), padS, WthC_ColorData.HIGH_BLUE, "This witch may become the envoy who controls the battlefield... or the hunter who weaves through death.");
        tooltip.addPara("She excels at commanding large carriers to provide continuous support from the rear, as well as piloting a frigate to precisely slaughter all larger targets.", WthC_ColorData.HIGH_BLUE, padS);
    ...
    public void performRightClickAction() {
        ...
        for(OfficerDataAPI member : this.player_fleet.getFleetData().getOfficersCopy()) {
            ...
            if(Objects.equals(officers.getId(), "WitchElf")){
                ...
                for (FleetMemberAPI member2 : this.player_fleet.getFleetData().getMembersListCopy()) {
                    ...
                    if(Objects.equals(officer2.getId(), "WitchElf")){
        ...
        if(!Global.getSector().getMemoryWithoutUpdate().getBoolean("$WthC_CAP")){
            ...
            this.officer.setId("WitchElfEX");
            this.officer.setPortraitSprite(Global.getSettings().getSpriteName("intel", "WPE1"));
