...
public class Crad_IE3EX extends BaseSpecialItemPlugin{
    ...
    public void performRightClickAction() {
        ...
        for(OfficerDataAPI member : this.player_fleet.getFleetData().getOfficersCopy()) {
            ...
            if(Objects.equals(officers.getId(), "WitchIEEX")){
                ...
                for (FleetMemberAPI member2 : this.player_fleet.getFleetData().getMembersListCopy()) {
                    ...
                    if(Objects.equals(officer2.getId(), "WitchIEEX")){
        ...
        Global.getSector().getMemoryWithoutUpdate().set("$IEEX-ON",false);
