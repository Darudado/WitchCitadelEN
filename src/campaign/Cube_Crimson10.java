...
public class Cube_Crimson10 extends BaseSpecialItemPlugin{
    ...
    public void performRightClickAction() {
        ...
        Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                "You mechanically activated a pile of Crimson Cubes... The overwhelmingly brilliant light show forced you to turn away... After all, it's just for the rewards, right?");
