...
public class Archives_CM233_YuanXingZhe extends BaseSpecialItemPlugin{
    ...
    public void createTooltip(TooltipMakerAPI tooltip, boolean expanded, CargoTransferHandlerAPI transferHandler, Object stackSource) {
        ...
        tooltip.addPara("Mission Name: %s ", pad, WthC_ColorData.MYSTERIOUS_PURPLE, "Thunder Like Rain");

        tooltip.addPara("Creator: %s ", pad, WthC_ColorData.HIGH_BLUE, "Traveler");
        ...
        tooltip.addPara("Style: %s ", padS, WthC_ColorData.HIGH_BLUE, "Missiles");
        tooltip.addPara("Description: %s ", padS, WthC_ColorData.HIGH_BLUE, "Big missiles inside, come get your fill");
        tooltip.addPara("It's just that kind of completely rule-breaking stacking game nonsense, you know what I mean.", WthC_ColorData.HIGH_BLUE, padS);
    ...
    public void performRightClickAction() {
        ...
        Global.getSector().getMemoryWithoutUpdate().set("$DR_YuanXingZhe",true);
    }
}
