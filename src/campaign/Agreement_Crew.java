...
public class Agreement_Crew extends BaseSpecialItemPlugin{
    ...
    public void createTooltip(TooltipMakerAPI tooltip, boolean expanded, CargoTransferHandlerAPI transferHandler, Object stackSource) {
        ...
        tooltip.addPara("The specific denomination corresponding to this protocol card: %s ", pad, WthC_ColorData.HIGH_BLUE, new String[]{"100 units of crew"});
        tooltip.addPara("Warning: %s ", pad, Misc.getNegativeHighlightColor(), new String[]{"The cost required for mass teleportation of organic lifeforms will be slightly increased"});
    ...
    public void performRightClickAction() {
        ...
        Global.getSector().getPlayerFleet().getCargo().addCommodity("crew",100f);
        Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                "You strictly followed the steps to activate a Dust-based Transfer Protocol Card... Accompanied by a visible burst of intense blue light, 100 units of minimally trained crew members appeared at the location you previously specified...");
