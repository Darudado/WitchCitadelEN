...
public class Agreement_Fuel extends BaseSpecialItemPlugin{
    ...
    public void createTooltip(TooltipMakerAPI tooltip, boolean expanded, CargoTransferHandlerAPI transferHandler, Object stackSource) {
        ...
        tooltip.addPara("The specific denomination corresponding to this protocol card: %s ", pad, WthC_ColorData.HIGH_BLUE, new String[]{"400 units of fuel"});
    ...
    public void performRightClickAction() {
        ...
        Global.getSector().getPlayerFleet().getCargo().addCommodity("fuel",400f);
        Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                "You strictly followed the steps to activate a Dust-based Transfer Protocol Card... Accompanied by a visible burst of intense blue light, 400 units of fuel appeared at the location you previously specified...");
