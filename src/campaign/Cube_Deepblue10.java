...
public class Cube_Deepblue10 extends BaseSpecialItemPlugin{
    ...
    public void performRightClickAction() {
        ...
        Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                "You mechanically activated a pile of Deep Blue Cubes... The overwhelmingly brilliant light show forced you to turn away... After all, it's just for the rewards, right?");
