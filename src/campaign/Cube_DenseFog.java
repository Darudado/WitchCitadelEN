...
public class Cube_DenseFog extends BaseSpecialItemPlugin{
    ...
    public void performRightClickAction() {
        ...
        if (RandomNumber1 <= 1F) {
            Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                    "You activated a Dense Fog Cube... Accompanied by a magnificent light show, you received... five Transfer Protocol Cards (Story Points)... (1% chance)");
            ...
            if(RandomNumber2 <= 25F){
                ...
                Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                        "You activated a Dense Fog Cube... Accompanied by a magnificent light show, you received... 1 mysterious large ballistic weapon~ (2% chance)");
                ...
                Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                        "You activated a Dense Fog Cube... Accompanied by a magnificent light show, you received... 1 super fighter LPC (2% chance)");
            }
        } else if(RandomNumber1 <= 10F){
            float RandomNumber2 = MathUtils.getRandomNumberInRange(0F, 100F);
            if(RandomNumber2 <= 66F){
                Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                        "You activated a Dense Fog Cube... Accompanied by a magnificent light show, you received... 1 mysterious medium energy weapon~ (7% chance)");
            ...
            if (!Global.getSector().getMemoryWithoutUpdate().getBoolean("$WthC_A1-ON")){
                ...
                Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                        "You activated a Dense Fog Cube... Accompanied by a magnificent light show, some strange information appeared on the cube~ (10% chance)");
                ...
                Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                        "You activated a Dense Fog Cube... Accompanied by a magnificent light show, you received... some mysterious planetary data (10% chance)");
                float RandomNumber2 = MathUtils.getRandomNumberInRange(0F, 100F);
                if (RandomNumber2 <= 25){
                ...
                if (RandomNumber3 <= 33F){
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Dense Fog Cube... Accompanied by a magnificent light show, you received... a Transfer Protocol Card (Crew)~! (15% chance)");
                    ...
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Dense Fog Cube... Accompanied by a magnificent light show, you received... a Transfer Protocol Card (Supplies)~! (15% chance)");
                    Global.getSector().getPlayerFleet().getCargo().addSpecial(new SpecialItemData("Agreement_Supplies", "special_items"), 1);
                } else {
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Dense Fog Cube... Accompanied by a magnificent light show, you received... a Transfer Protocol Card (Fuel)~! (15% chance)");
                ...
                if (RandomNumber4 <= 10F){
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Dense Fog Cube... Accompanied by a magnificent light show... you felt a sense of emptiness (No effect 25% chance)");
                } else if (RandomNumber4 <= 20F){
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Dense Fog Cube... Accompanied by a magnificent light show, you shivered without feeling cold... (No effect 25% chance)");
                } else if(RandomNumber4 <= 30F){
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Dense Fog Cube... Accompanied by a magnificent light show, you felt an unprecedented comfort... (No effect 25% chance)");
                } else if(RandomNumber4 <= 40F) {
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Dense Fog Cube... Accompanied by a magnificent light show, you felt a wave of depression... (No effect 25% chance)");
                } else if(RandomNumber4 <= 50F) {
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Dense Fog Cube... Accompanied by a magnificent light show, you suddenly felt overwhelmed with grief... (No effect 25% chance)");
                } else if(RandomNumber4 <= 60F) {
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Dense Fog Cube... Accompanied by a magnificent light show, you laughed maniacally... (No effect 25% chance)");
                } else if(RandomNumber4 <= 70F) {
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Dense Fog Cube... Accompanied by a magnificent light show, you felt boundless rage... (No effect 25% chance)");
                } else if(RandomNumber4 <= 80F) {
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Dense Fog Cube... Accompanied by a magnificent light show, you felt utterly exhausted... (No effect 25% chance)");
                } else if(RandomNumber4 <= 90F) {
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Dense Fog Cube... Accompanied by a magnificent light show, you felt a wave of dizziness... (No effect 25% chance)");
                } else {
                    Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                            "You activated a Dense Fog Cube... Accompanied by a magnificent light show, you felt an overwhelming sense of purpose... (No effect 25% chance)");
                }
        } else {
                Global.getSector().getCampaignUI().getMessageDisplay().addMessage(
                        "You activated a Dense Fog Cube... Accompanied by a magnificent light show, you received... a bunch of decorative weapons that are better than nothing (40% chance - guaranteed reward)");
