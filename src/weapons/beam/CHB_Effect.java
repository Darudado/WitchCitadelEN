...
//抄了一手北极星极化射流
public class CHB_Effect implements BeamEffectPlugin {
    ...
    public void advance(float amount, CombatEngineAPI engine, BeamAPI beam) {
        ...
        if (fireInterval.intervalElapsed()) {
            ...
            MissileAPI proj = (MissileAPI)engine.spawnProjectile(beam.getSource(), beam.getWeapon(), "WthC_CHB2", beam.getRayEndPrevFrame(), angle, vel);
