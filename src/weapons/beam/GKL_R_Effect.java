...
//抄了一手北极星极化射流
public class GKL_R_Effect implements BeamEffectPlugin {

    private final IntervalUtil fireInterval = new IntervalUtil(0.075f, 0.1f);
    ...
    public void advance(float amount, CombatEngineAPI engine, BeamAPI beam) {
        ...
        if (fireInterval.intervalElapsed()) {
            ...
            MissileAPI proj = (MissileAPI)engine.spawnProjectile(beam.getSource(), beam.getWeapon(), "WthC_GKL_R2", beam.getRayEndPrevFrame(), angle, vel);
