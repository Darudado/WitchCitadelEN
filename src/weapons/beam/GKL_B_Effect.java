...
//抄了一手北极星极化射流
public class GKL_B_Effect implements BeamEffectPlugin {
    ...
    public void advance(float amount, CombatEngineAPI engine, BeamAPI beam) {
        ...
        if (fireInterval.intervalElapsed()) {
            ...
            MissileAPI proj = (MissileAPI)engine.spawnProjectile(beam.getSource(), beam.getWeapon(), "WthC_GKL_B2", beam.getRayEndPrevFrame(), angle, vel);
