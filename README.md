...
The bounties are pretty hard so consider it endgame content. 

✨
 New Star System:
Adds a new system, called Void, with habitable planets.
Includes structures, obtainable during the main quest, to improve and develop these planets.

⚡
 New High-Tech Faction:
Introduces a faction focused on advanced beam weapons.
Note: Does not include some Nexerelin (Nex) 4X features (e.g., invasions.), the mod is mostly limited to its star system.

🎭
 Storyline:
A single storyline divided into two parts:
Crimson Invitation
Pale Contract

🎉
 Side Content:
Fun joke side quests
Chain bounties with some absurd fleets.
Note: Some optional side quests require the mods "Valkyrian" and "Prasrity_Scrap_Master".

🧙
 Overpowered Officers:
Recruit unique, overpowered officers called "Witches" to join your fleet.

⚠️
 Dependencies:
Requires the "Alice Ship Pack" mod to function properly.
⁠bootleg_updates⁠
-Only works in a not random sector. 

📜
 Flavor Text & Lore:
Tons of cryptic lore and badly translated flavor text.
May contain  a slight witch fetish.

🌐
 Translation Note:
This mod is a machine-translated version from Chinese. Some text may feel rough or unclear, especially names may not be correct.
Credits to the original creators are included inside the mod.
Fossil thread: https://www.fossic.org/thread-8970-1-1.html
